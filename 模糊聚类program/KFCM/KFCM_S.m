function [ center, U, obj_fcn ] = KFCM_S(data, data1, cluster_n, alfa, options)
...
U=initkfcm(cluster_n,data_n);      %初始化模糊分配矩阵，使U满足列上想加为1,每一个点到所有类的隶属度之和为1
...
for i =1:max_iter
    ...
    [U,center,obj_fcn(i)] = stepkfcm(data,data1,U,cluster_n,expo,alfa,segma);
    if display,
