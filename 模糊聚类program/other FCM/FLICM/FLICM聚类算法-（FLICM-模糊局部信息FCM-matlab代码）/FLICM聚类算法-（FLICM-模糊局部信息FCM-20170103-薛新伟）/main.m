...
close all;
clc
path='E:\biye\DTIpicture\data\DTIpicture\26.jpg';
tic;%tic %保留这一时刻
t6=clock;
...
for n=1:cluster_n   %按聚类结果分割图像
    ...
    switch index
        case 1
            color_class=0;
        case 2
            color_class=fix(255*(index-3)/(cluster_n-3));
        case 3
            color_class=fix(255*(index-3)/(cluster_n-3));
        case cluster_n
            color_class=255;
...
imwrite(I,'E:\matlab2\matlab anzhuangdizhi\bin\chengxu\第四(6)篇-局部模糊信息与马尔科夫结合+NCM\FLICM999.bmp');
imwrite(uint8(255-I),'E:\matlab2\matlab anzhuangdizhi\bin\chengxu\第四(6)篇-局部模糊信息与马尔科夫结合+NCM\FLICM9991.bmp');
