...
FCM_S1 = [0.1671, 0.18540, 0.2060, 0.2271, 0.2543];
FCM_S2 = [0.1663, 0.18184, 0.1968, 0.2128, 0.2406];
KFCM = [0.1713, 0.1859, 0.1988, 0.2145, 0.2387];
F = [0.1346, 0.1398, 0.1432, 0.1445, 0.1589];

plot(x, FCM, '-ob', x, FCM_S1, '-or', x, FCM_S2, '-ok', x, KFCM, '-og', x, F, '-om')
...
legend('FCM', 'FCM_S1', 'FCM_S2', 'KFCM', '本文');
...
FCM_S2 = [0.9207, 0.9147, 0.9099, 0.8986, 0.8848];
FCM_S1 = [0.9231, 0.9207, 0.9197, 0.9133, 0.9085];
...
FCM_S2 = [0.9635, 0.9525, 0.9459, 0.9323, 0.9292];
FCM_S1 = [0.9641, 0.9435, 0.9374, 0.9296, 0.9252];
